...
# putting button in parentheses allows mouse over to be applied to every button, without it, the function returns a positional argument as a TypeError
def Enter0(button):
...
def EnterSqrt(button):
    buttonSqrt['background'] = 'pale green'
...
buttonSqrt = Button(root, text=' √ ', fg='black', bg='lawn green', padx=0, pady=10, command=lambda: press('**0.5'), height=1, width=7)
...
buttonRP = Button(root, text=' ) ', fg='black', bg='light grey', padx=0, pady=10, command=lambda: press(')'), height=1, width=7)
buttonRP.grid(row=1, column=1)
buttonRP.bind('<Enter>',EnterRP)
buttonRP.bind('<Leave>',LeaveRP)

buttonLP = Button(root, text=' ( ', fg='black', bg='light grey', padx=0, pady=10, command=lambda: press('('), height=1, width=7)
buttonLP.grid(row=1, column=0)
buttonLP.bind('<Enter>',EnterLP)
buttonLP.bind('<Leave>',LeaveLP)

buttonPlus = Button(root, text=' + ', fg='black', bg='lawn green', padx=0, pady=10, command=lambda: press('+'), height=1, width=7)
buttonPlus.grid(row=5, column=3)
buttonPlus.bind('<Enter>',EnterPlus)
buttonPlus.bind('<Leave>',LeavePlus)

buttonMinus = Button(root, text=' - ', fg='black', bg='lawn green', padx=0, pady=10, command=lambda: press('-'), height=1, width=7)
buttonMinus.grid(row=4, column=3)
buttonMinus.bind('<Enter>',EnterMinus)
buttonMinus.bind('<Leave>',LeaveMinus)

buttonTimes = Button(root, text=' × ', fg='black', bg='lawn green', padx=0, pady=10, command=lambda: press('*'), height=1, width=7)
buttonTimes.grid(row=3, column=3)
buttonTimes.bind('<Enter>',EnterTimes)
buttonTimes.bind('<Leave>',LeaveTimes)

buttonExponent = Button(root, text=' x^y ', fg='black', bg='lawn green', padx=0, pady=10, command=lambda: press('**'), height=1, width=7)
buttonExponent.grid(row=2, column=4)
buttonExponent.bind('<Enter>',EnterExponent)
buttonExponent.bind('<Leave>',LeaveExponent)

buttonDivide = Button(root, text=' ÷ ', fg='black', bg='lawn green', padx=0, pady=10, command=lambda: press('/'), height=1, width=7)
