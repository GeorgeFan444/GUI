...
# ANS variable to enable the mamory function
ANS = '0'
...
# special number pi, using symbol instead of 3.1415 makes the expression box neater
π = 3.1415
...
# equal button is special because it is a function on its own, I will call it 'evaluate'
